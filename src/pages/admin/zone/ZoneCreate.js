...
import { createZoneWithGBAndSD } from "../../../functions/zone";
...
const ZoneCreate = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await createZoneWithGBAndSD(reqBody, user.token);

      console.log(res);
      //clear fields
      window.alert(`Zone "${res.data.zoneTitle}" is created successful.`);
